...
import os
print("Made by t.me/sudden_changes_sans for this project.")
print("Для выхода в screazesoft введите: exit")
...
print("Анализатор хэшэй запущен")
try:
    first = str(argv[1])
except:
    first = None
