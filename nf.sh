...
printf "\e[1;92m Найдено!\e[0m https://www.instagram.com/%s\n" $username
printf "https://www.instagram.com/%s\n" $username > $username.txt
elif [[ $check_insta == *'0'* ]]; then
printf "\e[1;93mНе Найдено!\e[0m\n"
fi

## Facebook

printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Facebook: \e[0m"
check_face=$(curl -s "https://www.facebook.com/$username" -L -H "Accept-Language: en" | grep -o 'Не Найдено'; echo $?)


if [[ $check_face == *'1'* ]]; then
printf "\e[1;92m Найдено!\e[0m https://www.facebook.com/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://www.twitter.com/%s\n" $username
...
check_youtube=$(curl -s "https://www.youtube.com/$username" -L -H "Accept-Language: en" | grep -o 'Не Найдено'; echo $?)


if [[ $check_youtube == *'1'* ]]; then
printf "\e[1;92m Найдено!\e[0m https://www.youtube.com/%s\n" $username
...
if [[ $check == *'1'* ]]; then
printf "\e[1;92m Найдено!\e[0m https://%s.blogspot.com\n" $username
...
if [[ $check == *'1'* ]]; then
printf "\e[1;92m Найдено!\e[0m https://plus.google.com/+%s/posts\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://www.reddit.com/user/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://%s.wordpress.com\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://www.pinterest.com/%s\n" $username
...
check1=$(curl -s -i "https://www.github.com/$username" -H "Accept-Language: en" -L --user-agent '"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:0.9.3) Gecko/20010801"' | grep -o '404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://www.github.com/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://%s.tumblr.com\n" $username
...
check1=$(curl -s -i "https://www.flickr.com/people/$username" -H "Accept-Language: en" -L --user-agent '"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:0.9.3) Gecko/20010801"' | grep -o 'Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://www.flickr.com/photos/%s\n" $username
...
check1=$(curl -s -i "https://steamcommunity.com/id/$username" -H "Accept-Language: en" -L --user-agent '"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:0.9.3) Gecko/20010801"' | grep -o 'The specified profile could Не be Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://steamcommunity.com/id/%s\n" $username
...
check1=$(curl -s -i "https://vimeo.com/$username" -H "Accept-Language: en" -L --user-agent '"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:0.9.3) Gecko/20010801"' | grep -o '404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://vimeo.com/%s\n" $username
...
check1=$(curl -s -i "https://soundcloud.com/$username" -H "Accept-Language: en" -L --user-agent '"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:0.9.3) Gecko/20010801"' | grep -o '404 Не Найдено'; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://soundcloud.com/%s\n" $username
...
check1=$(curl -s -i "https://disqus.com/$username" -H "Accept-Language: en" -L --user-agent '"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:0.9.3) Gecko/20010801"' | grep -o '404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://disqus.com/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://medium.com/@%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://%s.deviantart.com\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://vk.com/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://about.me/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://imgur.com/user/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://flipboard.com/@%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://slideshare.net/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://fotolog.com/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://open.spotify.com/user/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://www.mixcloud.com/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://www.scribd.com/%s\n" $username
...
check1=$(curl -s -i "https://www.badoo.com/en/$username" -H "Accept-Language: en" -L | grep -o '404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://www.badoo.com/en/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://www.patreon.com/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://bitbucket.org/%s\n" $username
...
check1=$(curl -s -i "https://www.dailymotion.com/$username" -H "Accept-Language: en" -L | grep -o '404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://www.dailymotion.com/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://www.etsy.com/shop/%s\n" $username
...
check1=$(curl -s -i "https://cash.me/$username" -H "Accept-Language: en" -L | grep -o '404 Не Найдено'; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://cash.me/%s\n" $username
...
check1=$(curl -s -i "https://www.behance.net/$username" -H "Accept-Language: en" -L | grep -o '404 Не Найдено'; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://www.behance.net/%s\n" $username
...
check1=$(curl -s -i "https://www.goodreads.com/$username" -H "Accept-Language: en" -L | grep -o '404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://www.goodreads.com/%s\n" $username
...
check1=$(curl -s -i "https://www.instructables.com/member/$username" -H "Accept-Language: en" -L | grep -o '404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://www.instructables.com/member/%s\n" $username
...
check1=$(curl -s -i "https://keybase.io/$username" -H "Accept-Language: en" -L | grep -o '404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://keybase.io/%s\n" $username
...
check1=$(curl -s -i "https://kongregate.com/accounts/$username" -H "Accept-Language: en" -L | grep -o '404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://kongregate.com/accounts/%s\n" $username
...
check1=$(curl -s -i "https://$username.livejournal.com" -H "Accept-Language: en" -L | grep -o '404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://%s.livejournal.com\n" $username
...
check1=$(curl -s -i "https://angel.co/$username" -H "Accept-Language: en" -L | grep -o '404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://angel.co/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://last.fm/user/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://dribbble.com/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://www.codecademy.com/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://en.gravatar.com/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://pastebin.com/u/%s\n" $username
...
check1=$(curl -s -i "https://foursquare.com/$username" -H "Accept-Language: en" -L | grep -o '404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://foursquare.com/%s\n" $username
...
check1=$(curl -s -i "https://www.roblox.com/user.aspx?username=$username" -H "Accept-Language: en" -L | grep -o '404 Не Найдено' ; echo $?)
...
check1=$(curl -s -i "https://www.gumroad.com/$username" -H "Accept-Language: en" -L | grep -o '404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://www.gumroad.com/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://%s.newgrounds.com\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://www.wattpad.com/user/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://www.canva.com/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://creativemarket.com/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://www.trakt.tv/users/%s\n" $username
...
check1=$(curl -s -i "https://500px.com/$username" -H "Accept-Language: en" -L | grep -o '404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://500px.com/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://buzzfeed.com/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://tripadvisor.com/members/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://%s.hubpages.com/\n" $username
...
check1=$(curl -s -i "https://$username.contently.com" -H "Accept-Language: en" -L | grep -o '404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://%s.contently.com\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://houzz.com/user/%s\n" $username
...
check1=$(curl -s -i "https://blip.fm/$username" -H "Accept-Language: en" -L | grep -o '404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://blip.fm/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://www.wikipedia.org/wiki/User:%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://news.ycombinator.com/user?id=%s\n" $username
...
check1=$(curl -s -i "https://www.codementor.io/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://www.codementor.io/%s\n" $username
...
check1=$(curl -s -i "https://www.reverbnation.com/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://www.reverbnation.com/%s\n" $username
...
check1=$(curl -s -i "https://www.designspiration.net/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://www.designspiration.net/%s\n" $username
...
check1=$(curl -s -i "https://www.bandcamp.com/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://www.bandcamp.com/%s\n" $username
...
check1=$(curl -s -i "https://www.colourlovers.com/love/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://www.colourlovers.com/love/%s\n" $username
...
check1=$(curl -s -i "https://www.ifttt.com/p/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://www.ifttt.com/p/%s\n" $username
...
check1=$(curl -s -i "https://www.ebay.com/usr/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Не Найдено\|eBay Profile - error' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://www.ebay.com/usr/%s\n" $username
...
check1=$(curl -s -i "https://$username.slack.com" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://%s.slack.com\n" $username
...
check1=$(curl -s -i "https://www.okcupid.com/profile/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://www.okcupid.com/profile/%s\n" $username
...
check1=$(curl -s -i "https://www.trip.skyscanner.com/user/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Не Найдено\|HTTP/2 410' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://www.trip.skyscanner.com/user/%s\n" $username
...
check1=$(curl -s -i "https://ello.co/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе Найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://ello.co/%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://tracky.com/~%s\n" $username
...
printf "\e[1;92m Найдено!\e[0m https://www.tripit.com/people/%s#/profile/basic-info\n" $username
...
check1=$(curl -s -i "https://$username.basecamphq.com/login" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Не Найдено' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mНе найдено!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Найдено!\e[0m https://%s.basecamphq.com/login\n" $username
